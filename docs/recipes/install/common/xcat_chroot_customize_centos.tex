...
customization within the chroot environment created for the desired {\em
 compute} instance. The following steps document the process to configure time
synchronization for compute resources and enable \NFS{}
...
# Enable chrony time service on computes and identify master host as local NTP server
