...
[sms](*\#*) echo "/etc/passwd -> /etc/passwd" >> /var/lib/confluent/public/os/(*\confluentprofile*)-default/syncfiles
[sms](*\#*) echo "/etc/group -> /etc/group" >> /var/lib/confluent/public/os/(*\confluentprofile*)-default/syncfiles
[sms](*\#*) echo "/etc/shadow -> /etc/shadow" >> /var/lib/confluent/public/os/(*\confluentprofile*)-default/syncfiles
\end{lstlisting}
% \end_ohpc_run
