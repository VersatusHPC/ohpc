...
[sms](*\#*) wwctl image exec --build=false BOSVER -- /bin/bash -ex <<- EOF
  ...
  OHPC_UBUNTU_REPO=${OHPC_REPO_ROOT}/updates/Ubuntu_24.04
  OHPC_RELEASE_DEB=ohpc-release_4.1-1ohpc1~noble_all.deb
