...
[sms](*\#*) psh compute echo \
        "\""${sms_ip}:/home /home nfs nfsvers=4,nodev,nosuid 0 0"\"" \>\> /etc/fstab
[sms](*\#*) psh compute echo \
        "\""${sms_ip}:/opt/ohpc/pub /opt/ohpc/pub nfs nfsvers=4,nodev 0 0"\"" \>\> /etc/fstab
[sms](*\#*) psh compute systemctl restart nfs-client.target
