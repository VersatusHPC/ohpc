...
is \texttt{Rocky-10.0-x86\_64-dvd.iso} (available from the Rocky
...
[sms](*\#*) copycds ${iso_path}/Rocky-10.0-x86_64-dvd.iso
\end{lstlisting}
% end_ohpc_run
...
[sms](*\#*) lsdef -t osimage
rocky10-x86_64-install-compute  (osimage)
rocky10-x86_64-netboot-compute  (osimage)
rocky10-x86_64-statelite-compute  (osimage)
\end{lstlisting}
