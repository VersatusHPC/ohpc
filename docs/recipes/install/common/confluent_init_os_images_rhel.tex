...
is \texttt{\isoimage{}} (available from the \OS{}
\href{\downloadpage{}}{\color{blue}download} page).
...
[sms](*\#*) osdeploy import ${iso_path} -n (*\confluentprofile*)
...
Distributions:
  ...
  rocky-9.5-x86_64
Profiles:
  alma-9.5-x86_64-default
  rhel-9.5-x86_64-default
  rocky-9.5-x86_64-default
\end{lstlisting}
...
\begin{lstlisting}[language=bash,literate={-}{-}1,keywords={},upquote=true,keepspaces,literate={BOSVER}{\baseos{}}1]
[sms](*\#*) echo "/etc/hosts -> /etc/hosts" >> /var/lib/confluent/public/os/(*\confluentprofile*)-default/syncfiles
