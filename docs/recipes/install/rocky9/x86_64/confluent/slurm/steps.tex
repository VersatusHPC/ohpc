...
\newcommand{\OS}{Rocky}
\newcommand{\baseOS}{\OS{[} 9.4}
\newcommand{\OSRepo}{\OS{}\_9.4}
...
\newcommand{\isoimage}{Rocky-9-latest-x86\_64-dvd.iso}
\newcommand{\downloadpage}{https://rockylinux.org/download/}
\newcommand{\confluentprofile}{rocky-9-x86\_64}
...
\input{common/nvidia_mountpoint}
